...
const Cart = () => {
  ...
  if (orderSuccess) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen gap-6 px-4">
        <h1 className="text-2xl text-[#0B254B] text-center orbitron-bold">
          Pedido Realizado!
        </h1>
        <div className="flex flex-col items-center gap-4 text-center">
          <p className="text-lg text-[#0B254B]">
  ...
  return (
    <div className="flex flex-col gap-4 min-h-screen items-center">
      <h1 className="text-2xl text-[#0B254B] text-center mt-10 orbitron-bold">
        Seu Carrinho
      </h1>
      <div className="flex flex-col lg:flex-row gap-8 w-full max-w-6xl px-4">
          ...
          {items.map((item) => (
            ...
            >
              ...
              <div className="flex flex-col gap-2 text-center sm:text-start w-full">
                <h3 className="text-lg text-[#0B254B] orbitron-bold">
                  {item.name}
                </h3>
                <p className="text-sm text-[#0B254B]">
        ...
        <div className="flex flex-col gap-4 w-full lg:w-80 bg-white p-6 rounded-lg shadow-md h-fit sticky top-4">
          <h2 className="text-xl text-[#0B254B] orbitron-bold">
            Resumo do pedido
          </h2>
          <div className="flex flex-col gap-2">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="text-lg font-bold text-[#0B254B]">
